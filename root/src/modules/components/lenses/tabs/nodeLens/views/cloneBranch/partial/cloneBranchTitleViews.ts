    ...
    buildLocateOrOpenInTabView: (
        ...
        if (optionToken === state.branchesState.tree.token) {
            ...
            return lensControlsViews.buildLocateButtonView(
                optionKey,
                'Show the option to be cloned in tree-view',
                className
            );
        }
    ...
    buildTitleView: (
        ...
        const detailsView: VNode[] = [
            ...
            h("div", { class: "child-controls br-option" }, [
                ...
                cloneBranchTitleViews.buildLocateOrOpenInTabView(
                    state,
                    optionToken,
                    optionKey,
                    nodeExists
            ...
            h("div", { class: "icon-group" }, [
                ...
                h("div", { class: "discussion-icon" }, ""),
                h("div", { class: "discussion-icon cloned" }, "")
            ]),
            h("h3", {}, "Clone branch"),
        ];
...
export default cloneBranchTitleViews;
